  ...
  "GET /service/info" should "return a successful response containing service information" in runIO {
    ...
    val expectedJsonResponse =
      json"""{
        ...
        "gitBranch" : "my-branch",
        "gitCommit" : "my-commit",
        "buildTimestamp": "2022-08-04T20:10:00.000Z",
        "timestamp": "2022-09-04T10:10:00.000Z"
      }"""
          ...
          .returns {
            IO.pure {
              ServiceInformation(
                ...
                Some("my-branch"),
                Some("my-commit"),
                new DateTime(2022, 8, 4, 20, 10, 0, 0, DateTimeZone.UTC),
                new DateTime(2022, 9, 4, 10, 10, 0, 0, DateTimeZone.UTC)
              )
            }
          }
      }
